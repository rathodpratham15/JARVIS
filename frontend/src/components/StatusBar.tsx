    ...
    <div className="w-full bg-[#111318] border-b border-zinc-800 select-none">
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-2">
        <div className="flex items-center gap-2">
          <span className={`w-2 h-2 rounded-full shrink-0 ${isOnline ? "bg-[#00E5FF] animate-pulse" : "bg-red-500"}`} />
      ...
      <div className="hidden md:grid max-w-7xl mx-auto grid-cols-4 divide-x divide-zinc-800">
        <div className="px-6 py-2.5">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <span className={`w-2 h-2 rounded-full ${isOnline ? "bg-[#00E5FF] animate-ping" : "bg-red-500"}`} />
